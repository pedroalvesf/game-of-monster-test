...
describe('Crie uma função que retorna as informações sobre uma pessoa aventureira', () => {
  it('Passado o Id de uma pessoa aventureira, retorne as informações no formato correto', () => {
